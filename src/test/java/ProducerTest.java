...
import com.iecas.kds.tools.kafka.kafkaClient.ProducerDataAPI_Object;
import com.iecas.kds.tools.kafka.kafkaClient.ProducerDataByPartitionAPI;
import com.iecas.kds.tools.kafka.kafkaClient.ProducerDataByPartitionAPI_Object;
       ...
       // HashMap map = new HashMap();
        ...
        for (int j = 0; j < m; j++) {
            ...
            if(index%n==0){
                ...
                ProducerDataAPI.sendDataList(topicName,list);
                //map.clear();
                list.clear();
                try {
                    Thread.sleep(2);
