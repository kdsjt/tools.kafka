...
if [ -n "$BITS" ]; then
    ...
    JAVA_MEM_OPTS=" -server -Xms4g -Xmx4g -XX:PermSize=256m -XX:SurvivorRatio=2 -XX:+UseParallelGC "
fi

CLASSPATH="$CLASSPATH:$CONF_DIR:$LIB_JARS"
echo -e "Starting the $SERVER_NAME ...\c"
java $JAVA_OPTS $JAVA_MEM_OPTS -classpath $CLASSPATH com.iecas.kds.tools.kafka.main.KafkaPro
